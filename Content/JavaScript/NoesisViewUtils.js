...
class NoesisViewUtils {
     ...
     */
    static createNoesisInstance(xamlPath, viewMode, gameInstance, playerController) {
        // 加载 XAML 资源
        ...
        const guiInstance = UE.NoesisViewModeFunctionLibrary.CreateNoesisInstance(gameInstance, xamlAsset, playerController, viewMode);
        if (guiInstance) {
     ...
     * @returns 是否成功添加
     */
    static attachToViewport(instance, gameInstance, zOrder = 0) {
        if (!instance) {
        ...
        // 设置输入模式为 UI 模式
        UE.WidgetBlueprintLibrary.SetInputMode_UIOnlyEx(playerController, instance, UE.EMouseLockMode.DoNotLock);
        // 设置键盘焦点
     ...
     * @returns NoesisInstance 或 null
     */
    static loadNoesisView(xamlPath, viewModeClassPath, gameInstance) {
...
exports.NoesisViewUtils = NoesisViewUtils;
//# sourceMappingURL=NoesisViewUtils.js.map